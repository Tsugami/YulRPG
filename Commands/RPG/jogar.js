...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const playerLevel = user.rpgLevel;
    const playerDano = user.dano;
    const playerManaAtual = user.manaatual;
    ...
    const monstro = new Discord.EmbedBuilder()
        ...
        .then(async (message) => {
          ...
          coletor.on('collect', async (collected) => {
            ...
            if (valor === 'lutar') {
              ...
              const dmgCalc = playerDano * monstroArmor;
